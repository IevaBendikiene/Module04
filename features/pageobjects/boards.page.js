...
class BoardsPage extends Page {
  ...
  get listTitleInput() {
    return $('//textarea[@data-testid="list-name-textarea" and @aria-label="Enter list name…"]');
  }
  get submitNewListBtn() {
    return $('//button[@data-testid="list-composer-add-list-button"]');
  }
  getlistElement(name) {
    return $(`//li[@data-testid="list-wrapper" and .//h2[@data-testid="list-name" and contains(text(), "${name}")]]`);
  }
  get addCardBtn(){
  ...
  get checkboxEl(){
    return $('//label[@data-testid="clickable-checkbox" and .//span[@data-color="green" and @data-testid="card-label"]]')
  }
  get trelloCard(){
